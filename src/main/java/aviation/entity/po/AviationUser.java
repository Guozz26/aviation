...
public class AviationUser {
	...
	public AviationUser(int userId, String userName, String userPwd, String userSex, Date userAge) {
		super();
		this.userId = userId;
		this.userName = userName;
		this.userPwd = userPwd;
	...
	public AviationUser(String userName, String userPwd, String userSex, Date userAge) {
		super();
		this.userName = userName;
		this.userPwd = userPwd;
		this.userSex = userSex;
	...
	public AviationUser(int userId) {
		super();
		this.userId = userId;
